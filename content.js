...
function searchForJustjoin(){
    const offers = document.getElementById('root').children[2].children[0].children[0].children[2].children[0].children[0].children[0]
    console.log(offers.children[0]);
    // chrome.runtime.sendMessage(
    //     {
    //         pageName: root.children[2].children[0].children[0].children[2].children[0].children[0].children[0].children[0].children[0].children[0].children[2].children[0].children[0].children[0].className
    //     }
    // );
}
function searchForNofluffjobs(){
    ...
    const offersArray = [];
    for(let i=0; i<offers.length; i++){
        console.log(offers[i].children[0])
        offersArray.push({
            offerName: offers[i].children[1].children[0].children[0].innerHTML,
...
function searchOffers(){
    ...
    if(window.location.href.includes("justjoin.it")){
        // searchForJustjoin();
    }
